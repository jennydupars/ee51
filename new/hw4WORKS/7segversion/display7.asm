...
;external function declarations
        ...
        EXTRN   ASCIISegTable:BYTE  ; 7-segment codes for segment buffer 
...
StoreSegTableValue:
	...
	XLAT	CS:ASCIISegTable        ; value is stored in AL
    
    MOV     BX, CX              ; move index of segbuffer into BX
    MOV     BYTE PTR segBuffer[BX], AL          ; move value into segbuffer 
