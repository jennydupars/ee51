...
; We use timer 0 for interrupts, so these functions are for initializing timer 0.
; The included functions are: 
;	Timer0EventHandler - calls KeypadMux at interrupts to repeatedly check for input 
...
;external function declarations
    ...
    EXTRN   KeypadMux:NEAR             ; function for repeatedly checking keypad input 
...
;					interrupts. It calls KeypadMux whenever interrupted.
; 					This will repeatedly scan the keypad for input. 
;
; Operation:		This function calls KeypadMux, which scans another row 
;					in the keypad. Then it sends a timer EOI to move on. 
;
; Arguments:		None.
; Return Value:		None.
