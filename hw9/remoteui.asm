...
HandleErrorEvent		PROC 	NEAR 
	...
	MOV 	BX, AX 				; move error value into index ////////////////////////////////////////// maybe multiply by 2 
...
KEY_COMMAND_ENTRY_SIZE 	EQU 	4 		; 2 words are 4 bytes, display and command
...
KEY_COMMAND_TABLE 	LABEL 	KEY_COMMAND_ENTRY
																		; Key value 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 00
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 01 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 02 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 03
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string) >		; 04 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string) >		; 05 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string) >		; 06 
	KEY_COMMAND_ENTRY<OFFSET(No_display_string), OFFSET(No_command_string)>	; 07
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 08
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 09
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 0a
	KEY_COMMAND_ENTRY<OFFSET(Increment_speed), 	OFFSET(Increment_speed)>	; 0b
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 0c
	KEY_COMMAND_ENTRY<OFFSET(Decrement_speed), 	OFFSET(Decrement_speed)>	; 0d
	KEY_COMMAND_ENTRY<OFFSET(Stop_robot_disp), 	OFFSET(Stop_robot_comm)>	; 0e
	KEY_COMMAND_ENTRY<OFFSET(No_display_string), OFFSET(No_command_string)>	; 0f
	
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 10
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 11 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 12 
	KEY_COMMAND_ENTRY<OFFSET(Direction_90), OFFSET(Direction_90)>			; 13
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 14
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string) >		; 15 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 16
	KEY_COMMAND_ENTRY<OFFSET(Direction_180), OFFSET(Direction_180)>			; 17
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 18
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 19 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 1a
	KEY_COMMAND_ENTRY<OFFSET(Direction_0), 	OFFSET(Direction_0)>			; 1b
	KEY_COMMAND_ENTRY<OFFSET(Speed_half), OFFSET(Speed_half)>				; 1c
	KEY_COMMAND_ENTRY<OFFSET(Speed_max), OFFSET(Speed_max)>					; 1d
	KEY_COMMAND_ENTRY<OFFSET(Speed_0), 	OFFSET(Speed_0)> 					; 1e
	KEY_COMMAND_ENTRY<OFFSET(No_display_string), OFFSET(No_command_string)>	; 1f

	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 20
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 21 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 22 
	KEY_COMMAND_ENTRY<OFFSET(Direction_270), OFFSET(Direction_270)>			; 23
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 24 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 25 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 26
	KEY_COMMAND_ENTRY<OFFSET(Increment_direction), OFFSET(Increment_direction)>	; 27
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 28 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 29 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 2a
	KEY_COMMAND_ENTRY<OFFSET(Decrement_direction), OFFSET(Decrement_direction)>	; 2b 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 2c 
	KEY_COMMAND_ENTRY<OFFSET(Laser_off_disp), OFFSET(Laser_off_comm)>		; 2d
	KEY_COMMAND_ENTRY<OFFSET(Laser_on_disp), OFFSET(Laser_on_comm)>			; 2e
	KEY_COMMAND_ENTRY<OFFSET(No_display_string), OFFSET(No_command_string)>	; 2f
	
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 30
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 31 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 32 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 33
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), 	OFFSET(No_command_string)>		; 34 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 35 
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 36
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 37
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 38 
	KEY_COMMAND_ENTRY<OFFSET(Turret_pos_30), OFFSET(Turret_pos_30)>			; 39 
	KEY_COMMAND_ENTRY<OFFSET(Turret_neg_30), OFFSET(Turret_neg_30)>			; 3a
	KEY_COMMAND_ENTRY<OFFSET(Invalid_key), OFFSET(No_command_string)>		; 3b 
	KEY_COMMAND_ENTRY<OFFSET(Turret_0), OFFSET(Turret_0)>					; 3c 
	KEY_COMMAND_ENTRY<OFFSET(Turret_pos_60), OFFSET(Turret_pos_60)>			; 3d
	KEY_COMMAND_ENTRY<OFFSET(Turret_neg_60), OFFSET(Turret_neg_60)>			; 3e
	KEY_COMMAND_ENTRY<OFFSET(No_display_string), OFFSET(No_command_string)>	; 3f
...
;
ERROR1 	LABEL 	BYTE 
	DB 	'Error: 1',ASCII_NULL
ERROR2 	LABEL 	BYTE 
	DB 	'Error: 2',ASCII_NULL
ERROR3 	LABEL 	BYTE 
	DB 	'Error: 3',ASCII_NULL
ERROR4 	LABEL 	BYTE 
	DB 	'Error: 4',ASCII_NULL
ERROR5 	LABEL 	BYTE 
	DB 	'Error: 5',ASCII_NULL
ERROR6 	LABEL 	BYTE 
	DB 	'Error: 6',ASCII_NULL
ERROR7 	LABEL 	BYTE 
	DB 	'Error: 7',ASCII_NULL
ERROR8 	LABEL 	BYTE 
	DB 	'Error: 8',ASCII_NULL	
ERROR9 	LABEL 	BYTE 
	DB 	'Error: 9',ASCII_NULL
